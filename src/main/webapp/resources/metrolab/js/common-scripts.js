...
// theme switcher
    ...
    var setColor = function (color) {
        $('#style_color').attr("href", "resources/metrolab/css/style-" + color + ".css");
        
        var hdrs = {};
        
        hdrs[$("meta[name='_csrf_header']").attr('content')] = 
        ...
        $.ajax({
        	...
        	processData: false,
        	error: function(jqXhr, status, errText) {
        		alert("There was a problem saving the theme color to your preferences: " + errText);
        	},
        	headers: hdrs
        });
    }
