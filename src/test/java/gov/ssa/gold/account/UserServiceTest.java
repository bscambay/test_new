...
public class UserServiceTest {
	...
	@Ignore("Needs to be updated to use new impl")
	@Test
	...
	public void shouldThrowExceptionWhenUserNotFound() {
		...
		when(accountRepositoryMock.findByPin("user@example.com")).thenReturn(null);
		// act
	...
	public void shouldReturnUserDetails() {
		...
		when(accountRepositoryMock.findByPin("user@example.com")).thenReturn(demoUser);

		// act
		UserDetails userDetails = userService.loadUserByUsername("user@example.com");

		// assert
		assertThat(demoUser.getPin()).isEqualTo(userDetails.getUsername());
